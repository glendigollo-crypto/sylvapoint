      ...
      <div className="w-full max-w-sm rounded-xl bg-sylva-900 border border-sylva-700 p-8 shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-lg bg-sylva-500 px-4 py-2 text-sm font-semibold text-white hover:bg-sylva-400 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
